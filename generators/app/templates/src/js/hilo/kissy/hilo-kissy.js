 ...
 */
KISSY.add('hilo/core/Hilo', function(S){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/core/Class', function(S){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/geom/Matrix', function(S, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/event/EventMixin', function(S, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/renderer/Renderer', function(S, Hilo, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/renderer/DOMRenderer', function(S, Class, Hilo, Renderer, Drawable){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/renderer/WebGLRenderer', function(S, Class, Renderer, Matrix){
...
return WebGLRenderer;
    ...
    requires: ['hilo/core/Class', 'hilo/renderer/Renderer', 'hilo/geom/Matrix']
});
/**
 * Hilo 1.0.0 for kissy
 * Copyright 2015 alibaba.com
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/Container', function(S, Hilo, Class, View){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/Sprite', function(S, Hilo, Class, View, Drawable){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/DOMElement', function(S, Hilo, Class, View, Drawable){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/Graphics', function(S, Hilo, Class, View, CacheMixin){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/Text', function(S, Class, Hilo, View, CacheMixin){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/BitmapText', function(S, Class, Hilo, Container, Bitmap){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/view/Button', function(S, Hilo, Class, View, Drawable){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/util/Ticker', function(S, Class, Hilo){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/tween/Tween', function(S, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/tween/Ease', function(S){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/loader/ScriptLoader', function(S, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/loader/LoadQueue', function(S, Class, EventMixin, ImageLoader, ScriptLoader){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/game/Camera', function(S, Hilo, Class){
 ...
 * Licensed under the MIT License
 */
KISSY.add('hilo/game/ParticleSystem', function(S, Hilo, Class, View, Container, Bitmap, Drawable){
...
return ParticleSystem;
    ...
    requires: ['hilo/core/Hilo', 'hilo/core/Class', 'hilo/view/View', 'hilo/view/Container', 'hilo/view/Bitmap', 'hilo/view/Drawable']
});